...
class User:
    ...
    def hack(self) -> None:
        ...
        Use the <edit> method fromthe Tweet class.
    ...
    def retweet(self, new_user: str, tweet: Tweet, new_date: date) -> Tweet:
        ...
        >>> u1 = User('Diane', 'Hehaho')
        >>> t2 = u1.retweet('Diane', t1, date(2017, 8, 20))
        >>> t2.content
        'David is so cool!'
        >>> t2.userid
        'Diane'
        ...
        """
        t = Tweet(new_user, new_date, tweet.content)
        t.likes = 0
        return t
