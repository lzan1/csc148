...
class Player():
    ...
    max_move:int
    goal:int
    def __init__(self, min_move, max_move, goal):
...
class RandomPlayer(Player):
    ...
    max_move: int
    goal: int
    def __init__(self,min_move:int, max_move:int, goal:int):
        Player.__init__(self,min_move, max_move, goal)

    def chose_move(self):
        random.randint(min_move, max_move)
